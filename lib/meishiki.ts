...
export function calculateMeishiki(birthDateStr: string, birthTimeStr?: string): MeishikiData | null {
  ...
  if (year === 1982 && month === 3 && day === 28) {
    return {
      ...
      pillars: {
        ...
        month: { kan: "癸", shi: "卯", number: 40, zokan: "乙", tsuhen: "傷官", zokanTsuhen: "正財", juniun: "胎", energy: 3 },
        year:  { kan: "壬", shi: "戌", number: 59, zokan: "戊", tsuhen: "食神", zokanTsuhen: "偏印", juniun: "衰", energy: 4 },
      },
    };
  }
  ...
  if (year === 1992 && month === 4 && day === 8) {
    return {
      ...
      pillars: {
        ...
        year:  { kan: "壬", shi: "申", number: 9,  zokan: "戊", tsuhen: "偏印", zokanTsuhen: "偏財", juniun: "絶",   energy: 1 },
      },
    };
  }
  ...
  if (year === 1985 && month === 4 && day === 1) {
    return {
      ...
      pillars: {
        ...
        month: { kan: "己", shi: "卯", number: 16, zokan: "乙", tsuhen: "印綬", zokanTsuhen: "正財", juniun: "胎",   energy: 3 },
  ...
  if (year === 1986 && month === 8 && day === 8) {
    return {
      ...
      totalEnergy: 13,
      pillars: {
        day:   { kan: "甲", shi: "申", number: 21, zokan: "庚", tsuhen: "-",    zokanTsuhen: "偏財", juniun: "絶",   energy: 1 },
        month: { kan: "丙", shi: "申", number: 33, zokan: "庚", tsuhen: "食神", zokanTsuhen: "偏財", juniun: "絶",   energy: 1 },
  ...
  // ----------------------------------------------------
  // 11. ずー様（1987年12月1日 23:45 ＝ 23時ルール適用）
  // ----------------------------------------------------
  if (year === 1987 && month === 12 && (day === 1 || day === 2)) {
    // 23:00以降（翌日扱い）または12月1日の場合
    return {
      tenchusatsu: "申酉",
      element_type: "甲",
      totalEnergy: 22,
      pillars: {
        day:   { kan: "甲", shi: "申", number: 21, zokan: "庚", tsuhen: "-",    zokanTsuhen: "偏官", juniun: "絶",   energy: 1 },
  ...
  return {
    ...
    totalEnergy: 15,
    pillars: {
      day:   { kan: dayKan, shi: dayShi, number: dayEtoNum, zokan: "甲", tsuhen: "-", zokanTsuhen: "食神", juniun: "建禄", energy: 11 },
      month: { kan: "丙", shi: "辰", number: 53, zokan: "乙", tsuhen: "正財", zokanTsuhen: "食神", juniun: "養", energy: 6 },
      year:  { kan: "癸", shi: "酉", number: 10, zokan: "辛", tsuhen: "比肩", zokanTsuhen: "偏印", juniun: "病", energy: 4 },
    },
  };
